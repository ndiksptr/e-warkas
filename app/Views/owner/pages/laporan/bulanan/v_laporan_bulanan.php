...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6 input-group">
          ...
          <div class="input-group-append">
            <button type="button" class="btn btn-primary" onclick="ViewLaporanBulanan()">
              <i class="fas fa-file-alt"></i> Lihat Laporan
            </button>

            <a href="<?=base_url('owner/print-Bulanan'); ?>" 
      ...
      <div id="table-view">
        <!-- Table laporan bulanan muncul di sini -->
      </div>
...
function ViewLaporanBulanan(){
  ...
  //   }
    ...
    $.ajax({
        type: "post",
        url: "<?= base_url('owner/laporan/viewlaporanbulanan'); ?>",
        data : {bulan:bulan},
        dataType: "json",
  ...
  $('#btn-print').on('click', function(print_bulanan){
print_bulanan.preventDefault();
let bulan = $('#bulan').val();
if(bulan){
  let url = "<?= base_url('owner/print-Bulanan?bulan=') ?>" + bulan;
